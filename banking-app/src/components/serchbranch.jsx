  ...
  function SearchBranch() {
    ...
    const { serach_branch,loading, error, loginMessage } = useSelector((state) => state.serach_branch)
    ...
    return (
      <div className="cbs-branches">
        <div className="cbs-branches__header">
          ...
          <Link to="/dashboard/branches/add" className="cbs-btn cbs-btn--primary">
        ...
        <div className="cbs-card cbs-card--table">
          <div className="cbs-table-wrap">
            <table className="cbs-table">
              ...
              <tbody>
                {
                  getbranch && getbranch.map((data, i) => (
                    <tr key={data._id}>
