...
function Product({ name, image, dec, price, addtocard, qty, cate, rating ,stock }) {
    ...
    return (
        <div className="card rounded-5 col-12 btn" style={{ width: "18rem", height: "auto", backgroundColor: "#FFF8E7" }}>
            <img
                src={image}
            ...
            <div className="card-body" >
                ...
                <h5 className="card-title mt-2">Price : {(price / 94 * 1000).toFixed(2)}₹</h5>
