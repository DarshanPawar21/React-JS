...
const Project = () => {
    return (<>
        <div className="container">
            <div className="f text-center mt-5 mb-4" id="Pro">
                PROJECT
            </div>
            <div className="container">
                <div className="row d-flex gap-4 justify-content-center">
                    <div className="card mb-3 bo col-4 bg-black text-white">
                        <img src={s1} className="card-img-top pt-3 rounded-5" alt="..." style={{width:"100%",height:"60%"}} />
                            <div className="card-body">
                                ...
                                <a className="card-text" href="https://github.com/DarshanPawar21/JavaScript/blob/main/TODO/output.md"><small className="btn px-5 bt btn-outline-warning">Go To</small></a>
                            </div>
                    </div>
                    <div className="card mb-3 bo col-7 bg-black text-white">
                        <img src={s2} className="card-img-top mt-2 rounded-4" alt="..." style={{width:"100%",height:"100%"}} />
                            <div className="card-body">
                                ...
                                <a className="card-text" href="https://drive.google.com/file/d/1OD0JLDT1IPvSxBNJU7-CGNr-N4FQqiOj/view"><small className="btn px-5 bt btn-outline-warning">Go To</small></a>
                            </div>
                    </div>
                    <div className="card mb-3 bo col-3 bg-black text-white">
                        <img src={s3} className="card-img-top mt-2 rounded-4" alt="..." style={{width:"100%",height:"70%"}} />
                            <div className="card-body">
                                ...
                                <a className="card-text" href="https://github.com/DarshanPawar21/JavaScript/blob/main/Final%20Pro/OUTPUT.md"><small className="btn px-5 bt btn-outline-warning">Go To</small></a>
                            </div>
                    </div>
                    <div className="card mb-3 bo col-3 bg-black text-white">
                        <img src={s4} className="card-img-top mt-2 rounded-4" alt="..." style={{width:"100%",height:"70%"}} />
                            <div className="card-body">
                                ...
                                <a className="card-text" href="https://github.com/DarshanPawar21/JavaScript/blob/main/WEATHER/OUTPUT.MD"><small className="btn px-5 bt btn-outline-warning">Go To</small></a>
                            </div>
                    </div>
                    <div className="card mb-3 bo col-5 bg-black text-white">
                        <img src={s5} className="card-img-top mt-2 rounded-4" alt="..." style={{width:"100%",height:"70%"}} />
                            <div className="card-body">
                                ...
                                <a className="card-text" href="https://drive.google.com/file/d/1p5exiIdh3rl7smmyrJ3cN7VhSHSq9Pw4/view"><small className="btn px-5 bt btn-outline-warning">Go To</small></a>
                            </div>
                    </div>
                </div>
            </div>
